...
func (s *WeatherService) collectWeatherData() {
	...
	for _, city := range s.cities {
		...
		log.Println("data fetched: ", weather)
		if err != nil {
...
// getall  data of one daya as well as get all data of one day for oen city
func (s *WeatherService) GetAllCitydata(cityName string) (*[]models.WeatherRecord, error) {
	// func (s *WeatherService) GetAllCitydata(cityName string) (interface{}, error) {
